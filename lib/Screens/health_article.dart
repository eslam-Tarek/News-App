...
class HeathArticle extends StatefulWidget {
  static String id = 'health';
  @override
  _SportArticleState createState() => _SportArticleState();
}

class _SportArticleState extends State<HeathArticle> {
  @override
  void initState() {
    super.initState();
    Provider.of<ListOfAricleViewModel>(context,listen: false).fetchArticleByCategoty('health');
  }
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('الصحه - Health',style: GoogleFonts.aBeeZee()),
        centerTitle: true,
