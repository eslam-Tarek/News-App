...
class _SportArticleState extends State<SportArticle> {
  @override
  void initState() {
    super.initState();
    Provider.of<ListOfAricleViewModel>(context,listen: false).fetchArticleByCategoty('sports');
  }
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('الرياضه - Sport',style: GoogleFonts.aBeeZee()),
        centerTitle: true,
