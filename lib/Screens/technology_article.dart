...
class TechnologyArticle extends StatefulWidget {
  static String id = 'technology';
  @override
  _TechnologyArticleState createState() => _TechnologyArticleState();
}

class _TechnologyArticleState extends State<TechnologyArticle> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('التكنولوجيا - Technology',style: GoogleFonts.aBeeZee()),
        centerTitle: true,
